// Cf: https://stackoverflow.com/questions/60169819/modern-approach-to-making-stdvector-allocate-aligned-memory
#include <limits>
#include <new>
#include <vector>
...
{
    template<typename T>
    using aligned_vector = std::vector<T, AlignedAllocator<T, 64> >; // 64 bytes = 512 bits
}
